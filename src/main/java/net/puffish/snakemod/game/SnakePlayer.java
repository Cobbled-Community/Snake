...
public class SnakePlayer {
	...
	private SnakePlayer(ServerLevel world, ServerPlayer player, DyeColor color) {
		this.world = world;
		this.player = player;
		this.color = color;
	...
	public static SnakePlayer setup(ServerLevel world, ServerPlayer player, DyeColor color, Vec3 pos) {
