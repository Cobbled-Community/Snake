...
public class SnakePlayingPhase extends SnakeActivePhase {
	...
	public SnakePlayingPhase(GameSpace gameSpace, ServerLevel world, SnakeMap map, SnakeManager snakeManager, FoodManager foodManager, ScoreboardManager scoreboardManager, int minAliveCount) {
